...
"}")
        ...
        self.tab_visual.setStyleSheet("QPushButton {\n"
"background-color: rgb(60, 60, 60);\n"
"border-radius: 5%;\n"
"border: 1px solid rgb(188, 188, 188);\n"
"font-size: 16pt;\n"
...
"}")
        ...
        self.label_background_color = QtWidgets.QLabel(self.tab_visual)
        self.label_background_color.setObjectName("label_background_color")
        self.tab_visuals_layout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_background_color)
        self.widget_background_color = QtWidgets.QWidget(self.tab_visual)
        self.widget_background_color.setObjectName("widget_background_color")
        self.widget_background_color_ayout = QtWidgets.QGridLayout(self.widget_background_color)
        self.widget_background_color_ayout.setContentsMargins(4, 0, 10, 0)
        self.widget_background_color_ayout.setObjectName("widget_background_color_ayout")
        self.color_label_background_color = ClickableLabel(self.widget_background_color)
        self.color_label_background_color.setFrameShape(QtWidgets.QFrame.Box)
        self.color_label_background_color.setText("")
        self.color_label_background_color.setObjectName("color_label_background_color")
        self.widget_background_color_ayout.addWidget(self.color_label_background_color, 0, 0, 1, 1)
        self.button_default_background_color = QtWidgets.QPushButton(self.widget_background_color)
        self.button_default_background_color.setMinimumSize(QtCore.QSize(30, 30))
        self.button_default_background_color.setMaximumSize(QtCore.QSize(30, 30))
        self.button_default_background_color.setStyleSheet("border-radius: 15%;")
        self.button_default_background_color.setText("")
        self.button_default_background_color.setIcon(icon)
        self.button_default_background_color.setIconSize(QtCore.QSize(25, 25))
        self.button_default_background_color.setObjectName("button_default_background_color")
        self.widget_background_color_ayout.addWidget(self.button_default_background_color, 0, 1, 1, 1)
        self.tab_visuals_layout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.widget_background_color)
        self.label_text_color = QtWidgets.QLabel(self.tab_visual)
        self.label_text_color.setObjectName("label_text_color")
        self.tab_visuals_layout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_text_color)
        self.widget_text_color = QtWidgets.QWidget(self.tab_visual)
        self.widget_text_color.setObjectName("widget_text_color")
        self.widget_text_color_layout = QtWidgets.QGridLayout(self.widget_text_color)
        self.widget_text_color_layout.setContentsMargins(4, 0, 10, 0)
        self.widget_text_color_layout.setObjectName("widget_text_color_layout")
        self.color_label_text_color = ClickableLabel(self.widget_text_color)
        self.color_label_text_color.setFrameShape(QtWidgets.QFrame.Box)
        self.color_label_text_color.setText("")
        self.color_label_text_color.setObjectName("color_label_text_color")
        self.widget_text_color_layout.addWidget(self.color_label_text_color, 0, 0, 1, 1)
        self.button_default_text_color = QtWidgets.QPushButton(self.widget_text_color)
        self.button_default_text_color.setMinimumSize(QtCore.QSize(30, 30))
        self.button_default_text_color.setMaximumSize(QtCore.QSize(30, 30))
        self.button_default_text_color.setStyleSheet("border-radius: 15%;")
        self.button_default_text_color.setText("")
        self.button_default_text_color.setIcon(icon)
        self.button_default_text_color.setIconSize(QtCore.QSize(25, 25))
        self.button_default_text_color.setObjectName("button_default_text_color")
        self.widget_text_color_layout.addWidget(self.button_default_text_color, 0, 1, 1, 1)
        self.tab_visuals_layout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.widget_text_color)
...
"}")
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.label_selection_color.setText(_translate("MainWidget", "Selection color"))
        self.label_background_color.setText(_translate("MainWidget", "Background color"))
        self.label_text_color.setText(_translate("MainWidget", "Text color"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_visual), _translate("MainWidget", "Visuals"))
